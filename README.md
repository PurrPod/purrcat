...
## License & Disclaimer / 许可证

This project is licensed under the **GNU GPL-3.0 License**.

- **Core copyleft**: Any distribution of modified core framework must be open-sourced under GPL-3.0.
- **Plugin/Extension exemption**: Plugins, Harness/Expert, and external services are **not subject to GPL contagion** — they can be closed-source and commercial.
