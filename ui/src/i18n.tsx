...
const messages = {
  'zh-CN': {
    ...
    market: {
      ...
      install: '安装', installed: '已安装', redownload: '重新下载',
      ...
      installAllTitle: '一键安装本仓库全部技能', installAllBtn: 'INSTALL ALL', redownloadAll: '重新下载全部',
      ...
      batchInstallingPrefix: '正在批量安装 ', batchInstallingSuffix: ' 个技能...',
  ...
  'en-US': {
    ...
    task: {
      ...
      dashboard: 'Dashboard', launch: 'LAUNCH MISSION', selectGraph: '1. Select Deployed Graph:',
    ...
    market: {
      ...
      install: 'Install', installed: 'Installed', redownload: 'Re-download',
      ...
      envFillHint: 'Fill in real values in Settings after installation',
      ...
      installAllTitle: 'Install all skills in this repository', installAllBtn: 'INSTALL ALL', redownloadAll: 'RE-DOWNLOAD ALL',
      ...
      batchInstallingPrefix: 'Batch installing ', batchInstallingSuffix: ' skills...',
