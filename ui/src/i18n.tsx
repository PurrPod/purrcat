...
const messages = {
  'zh-CN': {
    ...
    config: {
      ...
      deployRegistryHint: '拉取沙盒镜像时优先使用该源；留空则自动依次尝试 Docker Hub / ghcr.io / 公共代理',
  ...
  'en-US': {
    ...
    config: {
      ...
      deployRegistryLabel: 'Image Registry', deployRegistryPlaceholder: 'e.g. ghcr.nju.edu.cn',
      deployRegistrySave: 'Save', deployRegistrySaved: 'Registry saved — applies to next pull',
      deployRegistryHint: 'Tried first when pulling the sandbox image; empty = Docker Hub / ghcr.io / public proxies in order',
